...
const BaseCard: React.FC<BaseCardProps> = ({
  ...
  return (
    <div
      onClick={onClick} // ← 加这一句
      className="w-52 h-72 p-0.5 rounded-2xl border border-cyan-400 
                 shadow-[0_0_12px_rgba(0,204,255,0.33)] 
                 hover:scale-105 hover:rotate-[1deg] 
                 hover:shadow-[0_0_20px_rgba(0,204,255,0.66),_inset_0_0_30px_rgba(0,204,255,0.33)] 
